...
<body>
    <br><br><br>
    <center><h2><b>Register</b> or <b>Log-in</b></h2>
    ...
    <center><form class="form"  action="#" method="POST">
        ...
        <p class="message">Log-in now and get full access to our app. </p>
             <div class="flex">
            <label>
                <input required="" placeholder="" name="uname" id="uname" type="text" class="input">
                <span>Username</span>
            </label>
        ...
        <p class="signin">Did'n have an Account, Create one <a href="http://localhost/PHP/form.php?#">Register</a> </p>
    </form></center>
    <?php
...
if($_POST['register'])
{
    ...
    $query = "INSERT INTO Register values('$uname', '$em','$pas','$conpas')";
